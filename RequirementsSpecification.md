...
| req_4  | Controlling all foils                          | All foils of the system on the daggerboards as well as on the rudders need to be controllable individually so that heel and trim can be adjusted from the system.                                                                                                                                                                                             | General            | -      | M      |
