...
| req_8  | Freezing the height reference                  | Depending on the used sensor technology, the height reference needs to be freeced at certain pitch or heel angles until the boats position is in an excepted range again.                                                                                                                                                                                   | Savety / Fail Safe | -      | M      |
...
| req_16 | Depower Warning | Since the user is not aware about the current stability buffer of the boat due to continuous stabilisation in heel and pitch, the system should give a warning when the foiling system can't handle the righting moment anymore. This feature will prevent capsizing and any fast heeling movements. | Stability | – | C |
